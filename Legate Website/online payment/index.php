    ...
    <div id="home" class="tab-pane fade in active">
       <div class="payment-info"> 
                ...
                <input type="text" style="margin-bottom: 0px;"  id="outbppo6digits" name="outbppo6digits" placeholder="Enter Sales Order number"  onkeypress="javascript:return isNumber(event)" maxlength="6" onchange="count();"></div><input value="" disabled="disabled"  type="text" name="outbppoidentifier" id="outbppoidentifier" >
                      ...
                      <br>
						<div class="tab-for">
							<input type="button"  class="btn btn-success" value="Submit" id="outpofirstbtn" name="outpofirstbtn" onclick="outpobtnfirst()" style="font-size: 20px;font-weight: bolder;text-transform: initial;">
							<input type="button"  style="display: none;font-size: 20px;font-weight: bolder;text-transform: initial;" class="btn btn-success" name="outposecondbtn" id="outposecondbtn" value="Submit" onclick="outpobtnsecond()" >
							<input type="button" name="outthirdbtn" id="outthirdbtn" value="Confirm" onclick="outbtnthird()" style="display: none;font-size: 20px;font-weight: bolder;text-transform: initial;" class="btn btn-success"  >
						</div>
