    ...
    <div id="home" class="tab-pane fade in active">
       <div class="payment-info">
                      ...
                      <h3 class="pay-title">Customer Information</h3>
                        <div class="tab-for">       
                          <h5>Customer Name</h5>
                            <input type="text" value="" id="outpocustname" name="outpocustname" required="" disabled="disabled">
                          <h5>Hand Phone *do not include the (+65)</h5>
                            <input type="text" value="" id="outpohp" name="outpohp" required="" maxlength="8" onkeypress="javascript:return isNumber(event)" disabled="disabled">
                          <h5>Building Type</h5>
                            <select id="builtingtype" name="builtingtype" onchange="bpbuildingtype1();" disabled="disabled"><option value="HDB"> HDB </option> <option value="Condo"> Condo </option> <option value="Commercial"> Commercial </option><option value="Landed House">Landed House</option></select><br><br>
                          <h5 id="notHDBorLHlbl1" style="display: none;">Building Name</h5>
                            ...
                            <br><br>
                          <h5>Address</h5>                          
                            <input type="text" value="" id="outpoaddress" name="outpoaddress" required="" disabled="disabled">
                          <h5>Unit No. Example ( 00-00 )</h5>
                            <input type="text" value="" id="outpounitno" name="outpounitno" required="" disabled="disabled">
                          <h5>Postal Code</h5>
                            <input type="text" value="" id="outpopostalcode" name="outpopostalcode" required="" onkeypress="javascript:return isNumber(event)" onchange="checkpostal();" maxlength="6" disabled="disabled">
                        </div>  
                        <h3>Other Information</h3>
                          <div class="tab-for">
                            ...
                            <h5 id="totalinvoicelbl">Enter Invoice Total </h5>
                              <input type="text" name="outposubtotal" id="outposubtotal" required="" onkeypress="javascript:return isNumber(event)" onchange="outcomputepo()" disabled="disabled">
                        ...
                        <div class="clear"></div>
                      <br>
                      <input type="button"  class="btn btn-success" value="Submit" id="outpofirstbtn" name="outpofirstbtn" onclick="outpobtnfirst()" disabled="disabled">
